...
use state_machine_lib::{PublicParams, PublicValuesDeposit, KZG, ElGamal, Action, Deposit, deposit};
...
fn create_proof_fixture(
    ...
    std::fs::write(
        fixture_path.join(format!("{:?}-zk-state-machine-fixture-deposit-B.json", system).to_lowercase()),
